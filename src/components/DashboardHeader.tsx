    ...
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-[#1f2937] mb-10">
      <div className="flex items-start gap-4">
        <button 
          ...
          className="hidden md:flex p-2.5 rounded-xl bg-[#111827] border border-[#1f2937] text-[#9ca3af] hover:text-[#10a37f] hover:border-[#10a37f]/30 transition-all shadow-sm group"
